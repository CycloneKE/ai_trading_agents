...
'''
    ...
    with open(os.path.join(project_root, "start_trading_system.py"), "w", encoding="utf-8") as f:
        f.write(startup_script_content)
    
    print("[OK] Fixed startup script")
...
'''
    ...
    with open(os.path.join(project_root, "launch_bot.py"), "w", encoding="utf-8") as f:
        f.write(launcher_content)
    
    print("[OK] Created simple launcher: launch_bot.py")

def main():
    """Main function"""
    print("[INFO] Fixing startup issues...")
