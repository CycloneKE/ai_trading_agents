...
class BaseBroker(abc.ABC):
    ...
    def get_portfolio_history(self, period: str = '1D', timeframe: str = '1Min') -> Dict[str, Any]:
        ...
        Args:
            period: The period over which to retrieve history (e.g., '1D', '1W', '1M', '1A', 'all')
            timeframe: The resolution of the history (e.g., '1Min', '5Min', '15Min', '1H', '1D')
            
        Returns:
            Dict containing portfolio history
        """
