...
class DatabaseManager:
    ...
    def close(self):
        """Close the connection pool, releasing all pooled database connections.

        Without this, the SimpleConnectionPool (1-20 connections) is leaked on
        every agent shutdown/restart.
        """
    ...
    def _create_tables(self):
        ...
        try:
            ...
            cursor.execute("""
                ...
                CREATE INDEX IF NOT EXISTS idx_nse_symbol_date
                ON nse_daily_prices(symbol, date DESC);
            """)
