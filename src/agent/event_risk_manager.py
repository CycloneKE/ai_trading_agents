...
class EventRiskManager:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # Threading. Use an RLock (reentrant): get_status() holds the lock and
        # calls get_risk_events(), which re-acquires it — a plain Lock would
        # self-deadlock and hang any caller (e.g. the /health check).
